          ...
          {[
            ...
            <div key={p.label} className="mb16">
              <div className="row-sb mb8">
                <span className="text-sm font-semibold" style={{ color: "var(--text-2)" }}>{p.label}</span>
                <span className="text-xs text-mono" style={{ color: p.color, fontWeight: 700 }}>
          ...
          {bStats.map(b => (
            <div key={b.id} className="mb12">
              <div className="row-sb mb6">
                ...
                <span className="text-xs text-mono" style={{ fontWeight: 700, color: b.rate >= 70 ? "var(--green)" : b.rate >= 40 ? "var(--amber)" : "var(--red)" }}>{b.rate}%</span>
              </div>
